...
class TextTranslationPage extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Obx(() {
        ...
        return const _TextTranslationContent();
      }),
    );
  }
}

class _TextTranslationContent extends GetView<HomeController> {
  const _TextTranslationContent();
          ...
          child: ConstrainedBox(
            ...
            child: Obx(() {
              return Column(
                ...
                children: [
                  TranslationInput(
                    onChanged: controller.onSourceTextChanged,
                    onSubmitted: controller.onSourceTextSubmitted,
                  ),
